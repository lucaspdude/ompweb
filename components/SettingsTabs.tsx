...
import { Box, Bot, Cable, LayoutPanelLeft, Puzzle, Settings2, Shield, Wrench } from "lucide-react";
import { useI18n } from "@/lib/i18n";

export type SettingsTab = "general" | "models" | "skills" | "plugins" | "mcp" | "sidebar" | "security" | "developer-tools";

const TABS: Array<{ id: SettingsTab; Icon: typeof Settings2; needsWorkspace?: boolean }> = [
  { id: "general", Icon: Settings2 },
  { id: "security", Icon: Shield },
  { id: "developer-tools", Icon: Wrench },
